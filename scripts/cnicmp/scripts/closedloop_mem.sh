        ...
        cat > ${container_config[$pod_idx]} << EOF
{
    ...
    "image":{
        "image": "fastiov-benchmark/mem"        
    },
        "command": [
          "/home/mem_lat2", "134217728"
        ],
        "log_path":"/mem_lat128_fastiov3.log",
        "linux": {
		"resources": {
			"cpu_shares": 1024,
...
# "/home/mem_lat2", "67108864"
# "/home/file_lat2", "/home/compatible-benchmark-code/scientific/data/test.graphml", "1"
# "/home/mem_lat2", "1024"
