        ...
        cat > ${container_config[$pod_idx]} << EOF
{
    ...
    "image":{
        ...
        "command": [
          "python3", "/home/compatible-benchmark-code/video/python/function-net2.py", "http://10.88.0.1:5100/download/city.mp4", "/home/compatible-benchmark-code/test-tmp/city.mp4", "/home/compatible-benchmark-code/video/data/test", "1", "watermark", "0.01"
        ],
        "log_path":"/0.log",
        "linux": {
		"resources": {
