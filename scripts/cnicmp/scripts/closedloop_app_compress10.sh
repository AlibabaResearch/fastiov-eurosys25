        ...
        cat > ${container_config[$pod_idx]} << EOF
{
    ...
    "image":{
        ...
        "command": [
          "python3", "/home/compatible-benchmark-code/compression/python/function-net2.py", "http://10.88.0.1:5100/download/acmart.tar", "/home/compatible-benchmark-code/test-tmp/acmart.tar", "/home/compatible-benchmark-code/test-tmp/", "0.01"
        ],
        "log_path":"/0.log",
        "linux": {
		"resources": {
