        ...
        cat > ${container_config[$pod_idx]} << EOF
{
    ...
    "image":{
        ...
        "command": [
          "python3", "/home/compatible-benchmark-code/scientific/python/function-net2.py", "http://10.88.0.1:5100/download/test-graph-100000.pickle", "/home/compatible-benchmark-code/test-tmp/test-graph.pickle", "0.01" 
        ],
        "log_path":"/0.log",
        "linux": {
		"resources": {
